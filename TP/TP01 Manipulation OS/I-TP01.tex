...
Ellsworth Kelly a toujours été un grand observateur du monde qui l'entoure. Passionné par l'ornithologie dès son enfance, il continue de chercher de nouvelles sources d'inspiration tout au long de sa carrière. Lors d'un séjour parisien, il s'émerveille des scintillements de la lumière sur la Seine et des ombres sur le fleuve en fin de journée. Il cherche à capturer ces effets dans de nombreux dessins d'étude, et à trouver un équilibre entre ombre et lumière.

C'est grâce à une rencontre avec le couple d'artistes Jean Arp et Sophie Taeuber que Kelly trouve la solution à ses recherches. Lors d'une visite dans leur atelier à Meudon, il découvre leurs duo-collages. Ces \oe uvres, créées en collaboration, laissent une place importante au hasard. Kelly commence alors à utiliser le hasard dans son travail de création, dans le but d'éviter toute subjectivité et de retirer ainsi toute trace de sa personnalité.

Pour la réalisation de cette \oe uvre, intitulée Seine, Kelly dessine une grille de 41 carrés en hauteur, sur 82 en largeur. Dans une boîte, il place des papiers numérotés de 1 à 41. Pour la première colonne, Kelly pioche un papier, puis noircit le rectangle qui correspond au numéro sélectionné. Pour la seconde colonne, il pioche 2 papiers, puis 3 pour la troisième colonne et ainsi de suite. La colonne centrale est entièrement noircie. Il inverse ensuite le procédé pour la partie droite de l'\oe uvre. Le résultat obtenu en ensuite été peint sur un panneau en bois.

\begin{center}
\includegraphics[width=0.7\linewidth]{img/seine}
\end{center}

\item Proposer un code python permettant de générer cette image.
\end{enumerate}
\end{exercice}
