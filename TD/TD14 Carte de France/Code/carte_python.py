...
cursor = cnx.cursor()
# Villes de Bayonne et de Saint-Vincent-de-Paul dans les Landes
query = ("SELECT ville_nom_reel, ville_latitude_dms,ville_longitude_dms, ville_population_2010 AS Population FROM villes_france_free WHERE ville_nom_reel='Bayonne' or (ville_nom_reel='Saint-Vincent-de-Paul' and ville_code_postal='40990')")
