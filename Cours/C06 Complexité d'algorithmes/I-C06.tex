...
$C_T(n)=\sum\limits_{i=0}^{n-1} C_e+(n-i)(2.C_e)+3.C_e =C_e.\sum\limits_{i=0}^{n-1} 4+2.n-2.i=Ce.\left(4.n+2.n^2-2.\dfrac{n.(n-1)}{2}\right)=C_e.(3.n+n^2)$. Dans ce cas, $C_T \underset{n\rightarrow\infty}{\sim}C_e.n^2$.}{\vspace{3cm}}
